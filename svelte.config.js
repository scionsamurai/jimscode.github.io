	...
	highlight: {
		highlighter: async (code, lang = 'text') => {
			const highlighter = await getSingletonHighlighter({
				...
				langs: ['javascript', 'json', 'sql', 'typescript', 'html', 'css', 'markdown', 'svelte', 'rust', 'c', 'java', 'toml', 'yaml']
			})
			await highlighter.loadLanguage('javascript', 'json', 'sql', 'typescript', 'html', 'css', 'markdown', 'svelte', 'rust', 'c', 'java', 'toml', 'yaml')
